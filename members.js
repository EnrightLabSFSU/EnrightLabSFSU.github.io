const MEMBER_SECTIONS = [
    ...
    members: [
      {
        ...
        linkedin: 'https://www.linkedin.com/in/michaeljobenright/',
    ...
    members: [
      {
        ...
        field: 'Chemistry',
        linkedin: 'https://www.linkedin.com/in/adeline-rickard/',
      ...
      },
      {
        ...
        linkedin: 'https://www.linkedin.com/in/hani-sobhi-2709931b7/',
      ...
      },
      {
        ...
        linkedin: 'https://www.linkedin.com/in/arun-somasundaram-198338279/',
  ...
  },
  {
    ...
    members: [
      { name: 'Fay Harris', field: 'Chemistry', photo: IMAGES.members.fay, linkedin: 'https://www.linkedin.com/in/t-fay-harris-3b7b4728a/', bio: 'Fay Harris is a senior at San Francisco State University pursuing a BS in chemistry, a minor in music, and a minor in the classics. She feels very passionate about quantum dots. Fay is a Genentech Undergraduate Fellow.' },
      ...
      { name: 'Nahadi Munoz', field: 'Biochemistry', linkedin: 'https://www.linkedin.com/in/nahadi-mu%C3%B1oz-9467a0259/', bio: 'Nahadi is a senior at San Francisco State University majoring in Biochemistry. Nahadi is a Genentech Fellow.' },
      ...
      { name: 'Chidera Okoye', field: 'Biochemistry', photo: IMAGES.members.chidera, linkedin: 'https://www.linkedin.com/in/chidera-okoye-a24753340/', bio: 'Chidera Okoye is a third-year student majoring in B.S. Biochemistry at SF State, researching applications of copper nanoparticles. Chidera is an SEO Scholar.' },
      ...
      { name: 'Jollyn Gunardi', field: 'Chemistry', linkedin: 'https://www.linkedin.com/in/jollyn-gunardi/', bio: 'Jollyn is a sophomore at San Francisco State University majoring in Chemistry. Jollyn is an SEO Scholar.' },
      { name: 'Charlotte Wong', field: 'Engineering', photo: IMAGES.members.charlotte, linkedin: 'https://www.linkedin.com/in/charlottehailewong/', bio: 'Charlotte Wong is a sophomore at Harvey Mudd College majoring in engineering with an interest in materials. She is researching copper nanoparticles for CO₂ reduction. Charlotte received a 2026 Summer Experience Funding Award from Harvey Mudd College.' },
    ],
  },
  {
    title: 'Graduates and Former Members',
    members: [
      { name: 'Marcello Garbo', field: 'Chemistry', photo: IMAGES.members.marcello, linkedin: 'https://www.linkedin.com/in/marcellogarbo/', bio: 'Marcello Garbo earned his M.S. in Chemistry from SFSU in Spring 2026. His work focused on near-infrared–emitting semiconductor nanoparticles for biological imaging and luminescent solar concentrators. Marcello is now a Chemistry Ph.D. student at UC Irvine.' },
      { name: 'Chloe Peak', field: 'Chemistry', photo: IMAGES.members.chloe, linkedin: 'https://www.linkedin.com/in/chloe-peak/', bio: 'Chloe Peak earned her B.S. in Chemistry from SFSU in May 2026, studying semiconductor quantum dots for photocatalytic biomass conversion. Chloe is a Chemistry Ph.D. student at UC Merced.' },
      { name: 'Trang Le', field: 'Chemistry', linkedin: 'https://www.linkedin.com/in/racheltrangle/', bio: 'Trang is a senior at San Francisco State University majoring in Chemistry.' },
      { name: 'Emilio Aguilar', field: 'Chemistry', photo: IMAGES.members.emilio, linkedin: 'https://www.linkedin.com/in/emilioaguilar-01z/', bio: 'Emilio Aguilar graduated from SFSU in Spring 2025. His research included photocatalysis using quantum dots and a new synthesis for colloidally stable, colossal quantum dots greater than 40 nm. Emilio is a Compliant Investigation Technician at Abbott.' },
      ...
      { name: 'Alex Gomez', field: 'Biochemistry', photo: IMAGES.members.alex, photoClass: 'member-photo-top', linkedin: 'https://www.linkedin.com/in/alexander-gomez-4860072b7/', bio: 'Alex investigated near-infrared emissive quantum dots for bioimaging in the Enright Lab as an undergraduate. Alex is an SEO Fellow and recipient of the 2026 Physical Chemistry Prize for Life Sciences.' },
      { name: 'Robert Lam', field: 'Biochemistry', photo: IMAGES.members.robert, linkedin: 'https://www.linkedin.com/in/robert-lam-7b456a2a3/', bio: 'Robert Lam explored CO₂ reduction on ordered copper lattices to control product selectivity. Robert is a graduate student at USC and Genentech Undergraduate Fellow.' },
      ...
      { name: 'Catie Bodinger', field: 'Chemistry · Materials Science', photo: IMAGES.members.catie, linkedin: 'https://www.linkedin.com/in/catie-bodinger-3ab6a0203/', bio: 'Catie Bodinger is a graduate student at the University of Washington who investigated quantum dots for photocatalysis as an undergraduate at Western Washington University.' },
      ...
      { name: 'Gayatri Kundassery', field: 'Biochemistry', photo: IMAGES.members.gayatri, linkedin: 'https://www.linkedin.com/in/gayatrikundassery/', bio: 'Gayatri Kundassery is an undergraduate at the University of Washington pursuing a BS in Biochemistry with a minor in Climate Science.' },
...
function memberCard(m) {
  ...
  const photoClass = m.photoClass ? ` ${m.photoClass}` : '';
  const photo = m.photo
    ? `<img src="${m.photo}" alt="${m.name}" class="${photoClass.trim()}" loading="lazy">`
    : `<div class="member-placeholder" aria-hidden="true">${initials}</div>`;
  const name = m.linkedin
    ? `<h3><a href="${m.linkedin}" class="member-name-link" target="_blank" rel="noopener noreferrer">${m.name}</a></h3>`
    : `<h3>${m.name}</h3>`;
